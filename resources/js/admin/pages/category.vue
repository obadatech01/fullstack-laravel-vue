						...
						<table class="_table">
							...
							<tr v-for="(category, i) in categoryLists" :key="i" v-if="categoryLists.length">
								...
								<td>
									...
									<Button type="error" size="small" @click="showDeletingModal(category, i)" :loading="isDeleting" v-if="isDeletePermitted">Delete</Button>
                                </td>
							</tr>
								<!-- ITEMS -->
						</table>
...
export default {
    ...
    watch: {
        getDeleteModalObj(obj) {
            console.log('get index deleted: ' + obj.deletingIndex);
            if(obj.isDeleted) {
