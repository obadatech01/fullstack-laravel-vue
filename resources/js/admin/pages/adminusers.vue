			...
			<div class="container-fluid">
						...
						<table class="_table">
							...
							<tr v-for="(user, i) in users" :key="i" v-if="users.length">
								...
								<td>
									...
									<Button type="error" size="small" @click="showDeletingModal(user, i)" :loading="isDeleting">Delete</Button>
                                </td>
							</tr>
								<!-- ITEMS -->
						</table>
				...
				<Modal
					...
					<div slot="footer">
						...
						<Button type="primary" @click="editAdmin" :disabled="isAdding" :loading="isAdding">{{isAdding ? 'Updating..' : 'Edit admin'}}</Button>
					</div>
...
export default {
    ...
    methods: {
        ...
        async editAdmin() {
            ...
            if(this.editData.email.trim() == '') return this.e('E-mail is required');
