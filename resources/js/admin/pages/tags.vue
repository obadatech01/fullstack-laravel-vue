			...
			<div class="container-fluid">
						...
						<table class="_table">
							...
							<tr v-for="(tag, i) in tags" :key="i" v-if="tags.length">
								...
								<td>
									...
									<Button type="error" size="small" @click="showDeletingModal(tag, i)" :loading="isDeleting"  v-if="isDeletePermitted">Delete</Button>
                                </td>
							</tr>
								<!-- ITEMS -->
						</table>
				...
				<Modal
					...
					<div slot="footer">
						...
						<Button type="primary" @click="editTag" :disabled="isAdding" :loading="isAdding">{{isAdding ? 'Updating..' : 'Edit tag'}}</Button>
					</div>
